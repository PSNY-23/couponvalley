...
const coupons: Coupon[] = [
  ...
  },
  {
    ...
    description: "Get free shipping on all orders with no minimum purchase",
    brandName: "OnlineShop",
    brandLogo: "/placeholder.svg?height=100&width=100",
    expiryDate: "2025-06-30",
    usedCount: 987,
    slug: "onlineshop-freeshipping",
    isExclusive: true,
    type: "free-shipping",
  },
  {
    ...
    code: "TOYS25",
    title: "25% Off Toys",
    description: "Save 25% on all toys and games",
    brandName: "ToyStore",
    brandLogo: "/placeholder.svg?height=100&width=100",
    expiryDate: "2025-08-15",
    usedCount: 456,
    slug: "toystore-toys25",
    type: "percentage",
    value: "25%",
  },
  {
    ...
    description: "Get $100 off on laptops over $500",
    brandName: "ElectronicsHub",
    brandLogo: "/placeholder.svg?height=100&width=100",
    expiryDate: "2025-07-31",
    usedCount: 789,
    slug: "electronicshub-tech100",
    type: "fixed",
    value: "$100",
  },
]
  ...
  return (
    <div className="container py-8 md:py-12">
      <div className="mb-8 text-center">
        <h1 className="mb-2 text-3xl font-bold md:text-4xl">All Coupons</h1>
        <p className="mx-auto max-w-2xl text-muted-foreground">
          Browse all active coupons and deals from top brands. Copy codes with a single click and save on your
          purchases.
        </p>
      </div>
              ...
              <div className="p-4">
                ...
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-xs text-muted-foreground">Used: {coupon.usedCount} times</span>
                  </div>
                  {coupon.code ? (
                    ...
                    <Button variant="outline" size="sm" asChild>
                      <Link href={`/coupons/${coupon.slug}`}>Get Offer</Link>
                    </Button>
                  )}
                </div>
              </div>
