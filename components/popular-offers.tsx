                    ...
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      ...
                      {offer.code ? (
                        ...
                        <Button variant="outline" size="sm" asChild>
                          <Link href={`/offers/${offer.slug}`}>{t("getOffer")}</Link>
                        </Button>
                      )}
                    </div>
                  </div>
